function combine_sens_data(varargin)
global h
...
% plot(squeeze(brn(:,48,:)),'m');
% plot(squeeze(h.sim_data.sens_sig_data(:,48,:)),'b');
% plot(squeeze(nanmean(h.sim_data.sens_final(:,48,:),3)),'r'); plot(squeeze(nanmean(h.sim_data.sens_sig_data(:,48,:),3)),'g');
