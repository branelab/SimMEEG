function sm_search_for_hits(varargin)
global h
...
if isempty(found_idx)  % No peaks found
    ...
    [norm_swf2, norm_true_swf] = sm_calc_normalized_swf(h.current_3D_peak_idx); % need to z-normalize waves because InvSoln have different scales
